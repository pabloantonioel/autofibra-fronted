    ...
    <>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card ">
          ...
          <a href="mailto:hello@micael.com" className="p-text">contacto@autofibranaval.cl</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="phone" />
          <a href="tel:+1 (123) 456-7890" className="p-text">+56 (9) 6282 5117</a>
        </div>
      </div>
      {!isFormSubmitted ? (
        ...
        <div>
          <h3 className="head-text">
            Muchas gracias! Lo contactemos en breve!
          </h3>
        </div>
      )}
    </>
